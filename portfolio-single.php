...
$id = $_GET['id'];
$p_query = mysqli_query($connection,"SELECT COUNT(*) AS total, title,category,thumbnail,featured_image,summary FROM `portfolios` WHERE id = $id");
$p_assoc = mysqli_fetch_assoc($p_query);
?>
    <main>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="dashboard/image/<?=$p_assoc['featured_image']?>" alt="<?=$p_assoc['title']."image"?>">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2 class="text-center"><?=$p_assoc['title']?></h2>
                                    <p><?=nl2br($p_assoc['summary'])?></p>

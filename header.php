<?php 
    ...
    $setting_query = mysqli_fetch_assoc(mysqli_query($connection,"SELECT COUNT(*) as total,name,image, logo,copyright,tagline,office_address,email,phone,about FROM `settings`"));
    ...
    $partners_query = mysqli_query($connection,"SELECT * FROM partners");
?>
<!doctype html>

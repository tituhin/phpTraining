<?php
  require_once 'header.php';
	$id = $_GET['id'];
  $users = mysqli_query($connection,"SELECT COUNT(*) as total,title,category,summary FROM `portfolios` WHERE id = $id");
...
<div class="card pd-10 pd-sm-40">
    <form action="portfolio-edit-post.php" method="POST" class="col-lg-12 mx-auto" enctype="multipart/form-data">
        <div class="row">
         
           <div class="col-6 pd-20 mt-2">
           	<label class="text-dark tx-bold" >Title: <span class="tx-danger">*</span></label>
              <input type="hidden" name="id" value="<?=$id?>">
              <input class="form-control" placeholder="Enter Title" type="text" name="title"value="<?=$assoc['title']?>">
            ...
            <div class="col-6 pd-20 mt-2">
              ...
              <input class="form-control" placeholder="Enter category" type="text" name="category" value="<?=$assoc['category']?>">
              <?php if (isset($_SESSION['fieldErr'])): ?><span class="text-danger"><?=$_SESSION['fieldErr']?></span><?php endif ?>
            </div>
            <div class="col-6 pd-20 mt-2">
            ...
            <div class="col-12 pd-20 mt-1">
              ...
              <textarea class="form-control" rows="auto" name="summary"><?=$assoc['summary']?></textarea>

    ...
    <footer class="sl-footer">
        ...
        <div class="footer-right d-flex align-items-center">
          ...
          <a target="_blank" class="pd-x-5" href="//fb.com"><i class="fa fa-facebook tx-20"></i></a>
          <a target="_blank" class="pd-x-5" href="//twitter.com"><i class="fa fa-twitter tx-20"></i></a>
        </div>
      </footer>
    </div>
